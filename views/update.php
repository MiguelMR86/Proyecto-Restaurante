                            ...
                            <div class="p-5">
                                ...
                                <form action="update.php" method="post" class="user">
                                    ...
                                    <div class="form-group d-flex">
                                        <button type="updateSubmit" name="updateSubmit" class="btn btn-primary btn-user btn-block m-1">
                                            Update
                                        </button>
                                        <a href="./user.php" type="cancelSubmit" name="cancelSubmit" class="btn btn-secondary btn-user btn-block m-1">
                                            Cancel
                                        </a>
                                    </div>
                                </form>
