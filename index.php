...
$resultado = [
    'error' => false,
    'mensaje' => 'El usuario se encuentra logeado'
];
...
try {
    ...
    // DB query
    $sentencia = $conexion->prepare("SELECT admin, password FROM User WHERE dni = ?");
    $sentencia->bindParam(1, $_SESSION["user"], PDO::PARAM_STR, 9);
    $sentencia->execute();
